...
def calculate_average(numbers):
    ...
    except ZeroDivisionError:       # Передана пустая коллекция, либо нечего вычислять (все данные не корректны => деление на 0)
        print(f'В коллекции {sum_numbers, incorrect_count} нет данных для вычислений')
        average = 0
